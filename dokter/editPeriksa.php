...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($queryUpdate) {
        echo '<script>alert("Data berhasil diubah");window.location.href="index.php?page=periksa"</script>';
    } else {
        echo '<script>alert("Data gagal diubah");window.location.href="index.php?page=periksa"</script>';
    }
}
