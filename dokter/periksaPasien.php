        ...
        if ($queryInsertPeriksa) {
            ...
            foreach ($arrayObat as $obat) {
                ...
                if ($queryDetailPeriksa) {
                    echo '<script>alert("Pasien telah diperiksa");window.location.href="index.php?page=periksa"</script>';
                } else {
                    echo '<script>alert("Error");window.location.href="index.php?page=periksa"</script>';
                }
            }
        }
    }
